...
# the meat
sketch.addGeometry(Part.Circle(App.Vector(0.000000,0.000000,0),App.Vector(0,0,1),10),True)
sketch.addConstraint(Sketcher.Constraint('Weight',0,1.000000))
sketch.addConstraint(Sketcher.Constraint('Coincident',0,3,-1,1))

sketch.addGeometry(Part.Circle(App.Vector(28.3069,4.7619,0),App.Vector(0,0,1),10),True)
sketch.addConstraint(Sketcher.Constraint('Equal',0,1)) 

sketch.addGeometry(Part.Circle(App.Vector(49.7354,15.3439,0),App.Vector(0,0,1),10),True)
